...
def run_tna(data_path: str, params: fun.Parameters) -> fun.TransientNutations:
    """
...
def run_tna_2d(data_path: str, params: fun.Parameters) -> fun.TransientNutations:
    """
...
def _resolve_fourier_params(params: fun.Parameters) -> tuple[int, float]:
    """
...
def _apply_processing(data: fun.TransientNutations, params: fun.Parameters):
    """
...
plt.plot(d.freq, d.freq_signal[140])
plt.show()
